...
const Footer = () => {
  return (
    <div>
      <footer class="bg-[#080312]">
        <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
          <div class="mx-auto max-w-md">
            <strong class="block text-center text-xl font-bold text-gray-100 sm:text-3xl">
            ...
            <form class="mt-6">
              <div class="relative max-w-lg">
                ...
                <input
                  class="w-full rounded-full border-gray-200 bg-gray-100 p-[18px]  text-sm font-medium"
                  id="email"
                  type="email"
                  placeholder="john@doe.com"
                />

                <button class="absolute right-[0%]  rounded-full bg-blue-600 px-4 lg:py-2 text-sm font-medium text-white transition hover:bg-blue-700">
                  Subscribe
                </button>
              </div>
            </form>
          ...
          <div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
            <div class="mx-auto max-w-sm lg:max-w-none">
              <p class="mt-4 text-center text-gray-500 lg:text-left lg:text-lg">
                RoboAdvisors relies on information from various sources believed
                to be reliable, including clients and third parties, but cannot
